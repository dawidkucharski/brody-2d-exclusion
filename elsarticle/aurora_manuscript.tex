...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lll@{}}
    \toprule
    Data type & CSR baseline & When to use \\
    \midrule
    Continuous 2D point processes & $\beta_{\text{CSR}}=0.96\pm0.15$ & Default for FV surfaces, PSI \\
    Binary fields at $\rho<0.2$ & Density-matched Bernoulli & Primes, arithmetic sequences \\
    Uncertain & Generate own CSR (20 realisations) & Any new data class \\
    \bottomrule
  \end{tabular}
\end{table}
